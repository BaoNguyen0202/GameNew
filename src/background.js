...
PIXI.Assets.add('flowerTop', '/assets/images/startScreenBackground.png');
PIXI.Assets.add('eggHead', '/assets/images/invader.png');
...
PIXI.Assets.load('eggHead').then((texture) => {
    ...
    character.on('pointertap', async () => {
        ...
        character.texture = await PIXI.Assets.load(
